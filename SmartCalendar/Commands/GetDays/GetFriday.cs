...
{
    public class GetFriday : Command
    {
        public override string[] Names { get; set; } = new string[] { "Пятница", "пятница", "ПЯТНИЦА" };
        ...
        public override async void Execute(Message message, TelegramBotClient client)
        {
            ...
            if (mes != null)
            {
                await client.SendTextMessageAsync(message.Chat.Id, "Пятница:\n" + mes);
            }
            else
            {
